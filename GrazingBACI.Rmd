...
boxplot_closed_year <- ggplot(rd_tidy, aes(x=Year, y=nClosedNests, fill=Site))+
  geom_boxplot()+
  scale_fill_manual(values = c('Control'='#ece2f0', 'Site1' = '#a6bddb', 'Site2' = '#1c9099'))+
  theme_bw()+
  theme(text=element_text(size=16))+
  #ggtitle("Closed nests (reproduction)") +
  ylab("Number of nests")+xlab("Year") +
...
boxplot_closed_site <- ggplot(rd_tidy, aes(x=Site, y=nClosedNests, fill=Year))+
  geom_boxplot()+
  scale_fill_manual(values = c('2018'='#ece2f0', '2019' = '#a6bddb', '2020' = '#1c9099'))+
  theme_bw()+
  theme(text=element_text(size=16))+
  #ggtitle("Closed nests (reproduction)") +
  ylab("Number of nests")+xlab("Site") +
